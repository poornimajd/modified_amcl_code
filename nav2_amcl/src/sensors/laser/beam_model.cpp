...
bool
BeamModel::sensorUpdate(pf_t * pf, LaserData * data, geometry_msgs::msg::PoseStamped & image_pose_rx_,geometry_msgs::msg::PoseStamped & image_pose_rx_2)
{
  double a = image_pose_rx_.pose.position.x; // just assigned to avoid warning of unused variable for now
  double aa = image_pose_rx_2.pose.position.x;
