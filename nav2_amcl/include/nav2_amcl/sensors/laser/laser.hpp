...
public:
   ...
   */
  virtual bool sensorUpdate(pf_t * pf, LaserData * data , geometry_msgs::msg::PoseStamped & image_pose_rx_,geometry_msgs::msg::PoseStamped & image_pose_rx_2) = 0;
...
public:
   ...
   * @return if it was succesful
   */
  bool sensorUpdate(pf_t * pf, LaserData * data, geometry_msgs::msg::PoseStamped & image_pose_rx_,geometry_msgs::msg::PoseStamped & image_pose_rx_2);
...
public:
  ...
  bool sensorUpdate(pf_t * pf, LaserData * data, geometry_msgs::msg::PoseStamped & image_pose_rx_,geometry_msgs::msg::PoseStamped & image_pose_rx_2);
  static void getCofactor(double mat[3][3], double temp[3][3], int p,int q, int n);
  static double determinantOfMatrix(double mat[3][3], int n);
  static void adjoint(double A[3][3],double adj[3][3]);
  static bool inverse(double A[3][3], double inverse[3][3]);
  static double gaussian_pdf(double posev[3],double term1,double term2[3][3],double mean_pos_x,double mean_pos_y,double mean_pos_theta, double new_pose);

  //static LikelihoodFieldModel myobj;
private:
  /*
