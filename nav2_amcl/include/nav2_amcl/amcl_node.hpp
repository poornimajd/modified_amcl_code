...
protected:
  ...
  void imagePoseReceived(geometry_msgs::msg::PoseStamped::SharedPtr msg);
  void imagePoseReceived2(geometry_msgs::msg::PoseStamped::SharedPtr msg);

  geometry_msgs::msg::PoseStamped image_pose_rx_;
  geometry_msgs::msg::PoseStamped image_pose_rx_2;
